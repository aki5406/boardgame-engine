...
It intentionally does not include global slash command registration, ITO session creation, player management, persistence, Docker, or deployment settings yet.
